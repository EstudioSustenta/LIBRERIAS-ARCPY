...
def denue(nummapa,distancia):
    ...
    try:
        ...
        with arcpy.da.SearchCursor(clipsalida,['NEAR_DIST',
            ...
            archivo = "{}Near_DENUE.txt".format(carpeta_proy)
        ...
        exportma.exportar(carpeta_proy,nombarch)
...
def analisis_manz(nummapa):
    ...
    "poblacion total": {
        "Campo": "POB1", 
        "diametro": 1000, 
        "expresionsql": "sub-titulo 1111", 
        "layerfile": "manzana_localidad POB1", 
        "quitasimb" : "no"},
    "densidad de poblacion": {
        "Campo": "dens_ha", 
        "diametro": 1000, 
        "expresionsql": "sub-titulo 1222", 
        "layerfile": "manzana_localidad densidad", 
        "quitasimb" : "no"},
    "poblacion dominante": {
        "Campo": "pobdom", 
        "diametro": 600, 
        "expresionsql": 
        "sub-titulo 1333", 
        "layerfile": "manzana_localidad dominante", 
        "quitasimb" : "si"},
