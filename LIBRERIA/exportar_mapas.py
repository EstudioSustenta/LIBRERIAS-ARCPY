...
def exportar(r_dest):
    ...
    try:
        # arcpy.mapping.ExportToJPEG(mxd, r_dest_utf8 + ".jpg", u"page_layout", 1024, 768, 250)  # Exportar a JPEG
        arcpy.mapping.ExportToPDF(mxd, r_dest_utf8 + ".pdf", u"page_layout", 1024, 768, 350)  # Exportar a PDF
